...
## re-fit all the varying effects models but with all Indo-European societies excluded
...
write.csv(data.frame(tr_vareff_prec), file="tr_vareff_noIE_prec.csv")
tr_vareff_post <- extract.samples(tr_vareff,pars=c("cutpoints","a","bMR","mu_a","mu_bMR","sigma_a","sigma_bMR","sigma_e")) 
write.csv(data.frame(tr_vareff_post), file="tr_vareff_noIE_post.csv")
...
write.csv(data.frame(tr_pi_vareff_prec), file="tr_pi_vareff_noIE_prec.csv")
...
write.csv(data.frame(tr_pi_vareff_post), file="tr_pi_vareff_noIE_post.csv")
...
write.csv(data.frame(mm_vareff_prec), file="mm_vareff_noIE_prec.csv")
mm_vareff_post <- extract.samples(mm_vareff,pars=c("cutpoints","a","bMR","mu_a","mu_bMR","sigma_a","sigma_bMR","sigma_e")) 
write.csv(data.frame(mm_vareff_post), file="mm_vareff_noIE_post.csv")
...
write.csv(data.frame(mm_pi_vareff_prec), file="mm_pi_vareff_noIE_prec.csv")
...
write.csv(data.frame(mm_pi_vareff_post), file="mm_pi_vareff_noIE_post.csv")
...
write.csv(data.frame(mc_vareff_prec), file="mc_vareff_noIE_prec.csv")
mc_vareff_post <- extract.samples(mc_vareff,pars=c("a","bMR","mu_a","mu_bMR","sigma_a","sigma_bMR","sigma")) 
write.csv(data.frame(mc_vareff_post), file="mc_vareff_noIE_post.csv")
...
write.csv(data.frame(mc_pi_vareff_prec), file="mc_pi_vareff_noIE_prec.csv")
mc_pi_vareff_post <- extract.samples(mc_pi_vareff,pars=c("a","bMR","bPI","mu_a","mu_bMR","mu_bPI","sigma_a","sigma_bMR","sigma_bPI","sigma")) 
write.csv(data.frame(mc_pi_vareff_post), file="mc_pi_vareff_noIE_post.csv")
...
write.csv(data.frame(ps_vareff_prec), file="ps_vareff_noIE_prec.csv")
...
write.csv(data.frame(ps_vareff_post), file="ps_vareff_noIE_post.csv")
...
write.csv(data.frame(wi_vareff_prec), file="wi_vareff_noIE_prec.csv")
...
write.csv(data.frame(wi_vareff_post), file="wi_vareff_noIE_post.csv")
...
write.csv(data.frame(rw_vareff_prec), file="rw_vareff_noIE_prec.csv")
...
write.csv(data.frame(rw_vareff_post), file="rw_vareff_noIE_post.csv")
...
write.csv(data.frame(pd_vareff_prec), file="pd_vareff_noIE_prec.csv")
...
write.csv(data.frame(pd_vareff_post), file="pd_vareff_noIE_post.csv")
...
write.csv(data.frame(dc_vareff_prec), file="dc_vareff_noIE_prec.csv")
dc_vareff_post <- extract.samples(dc_vareff,pars=c("cutpoints","a","bDC","mu_a","mu_bDC","sigma_a","sigma_bDC","sigma_e")) 
write.csv(data.frame(dc_vareff_post), file="dc_vareff_noIE_post.csv")
...
write.csv(data.frame(ai_vareff_prec), file="ai_vareff_noIE_prec.csv")
...
write.csv(data.frame(ai_vareff_post), file="ai_vareff_noIE_post.csv")
...
write.csv(data.frame(vi_vareff_prec), file="vi_vareff_noIE_prec.csv")
...
write.csv(data.frame(vi_vareff_post), file="vi_vareff_noIE_post.csv")
...
write.csv(data.frame(vn_vareff_prec), file="vn_vareff_noIE_prec.csv")
...
write.csv(data.frame(vn_vareff_post), file="vn_vareff_noIE_post.csv")
