...
## re-fit all the models but with all Indo-European societies excluded
mono_data <- read.csv("monogamy_NEW.csv",header=TRUE)
mono_data <- subset(mono_data,family_glottolog!="Indo-European") # drop all Indo-Europeans according to Glottolog classification
...
mono_tree <- keep.tip(mono_tree,soc) # drop Indo-Europeans
...
write.csv(data.frame(tr_prec), file="tr_noIE_prec.csv")
tr_post <- extract.samples(tr,pars=c("cutpoints","bMR","phy","ep","eta_phy","eta_ep","rho_phy","rho_ep")) 
write.csv(data.frame(tr_post), file="tr_noIE_post.csv")
...
write.csv(data.frame(tr_pi_prec), file="tr_pi_noIE_prec.csv")
tr_pi_post <- extract.samples(tr_pi,pars=c("cutpoints","bMR","bPI","phy","ep","eta_phy","eta_ep","rho_phy","rho_ep")) 
write.csv(data.frame(tr_pi_post), file="tr_pi_noIE_post.csv")
...
write.csv(data.frame(mm_prec), file="mm_noIE_prec.csv")
mm_post <- extract.samples(mm,pars=c("cutpoints","bMR","phy","ep","eta_phy","eta_ep","rho_phy","rho_ep")) 
write.csv(data.frame(mm_post), file="mm_noIE_post.csv")
...
write.csv(data.frame(mm_pi_prec), file="mm_pi_noIE_prec.csv")
mm_pi_post <- extract.samples(mm_pi,pars=c("cutpoints","bMR","bPI","phy","ep","eta_phy","eta_ep","rho_phy","rho_ep")) 
write.csv(data.frame(mm_pi_post), file="mm_pi_noIE_post.csv")
...
write.csv(data.frame(mc_prec), file="mc_noIE_prec.csv")
mc_post <- extract.samples(mc,pars=c("a","bMR","sigma","eta_phy","eta_ep","rho_phy","rho_ep")) 
write.csv(data.frame(mc_post), file="mc_noIE_post.csv")
...
write.csv(data.frame(mc_pi_prec), file="mc_pi_noIE_prec.csv")
mc_pi_post <- extract.samples(mc_pi,pars=c("a","bMR","bPI","sigma","phy","ep","eta_phy","eta_ep","rho_phy","rho_ep")) 
write.csv(data.frame(mc_pi_post), file="mc_pi_noIE_post.csv")
...
write.csv(data.frame(ps_prec), file="ps_noIE_prec.csv")
ps_post <- extract.samples(ps,pars=c("cutpoints","bPS","bWI","bPI","phy","ep","eta_phy","eta_ep","rho_phy","rho_ep")) 
write.csv(data.frame(ps_post), file="ps_noIE_post.csv")
...
write.csv(data.frame(pd_prec), file="pd_noIE_prec.csv")
pd_post <- extract.samples(pd,pars=c("cutpoints","bPD","bIA","eta_phy","eta_ep","rho_phy","rho_ep")) 
write.csv(data.frame(pd_post), file="pd_noIE_post.csv")
...
write.csv(data.frame(dc_prec), file="dc_noIE_prec.csv")
dc_post <- extract.samples(dc,pars=c("cutpoints","bDC","eta_phy","eta_ep","rho_phy","rho_ep")) 
write.csv(data.frame(dc_post), file="dc_noIE_post.csv")
...
write.csv(data.frame(ai_prec), file="ai_noIE_prec.csv")
ai_post <- extract.samples(ai,pars=c("cutpoints","bAL","bIC","eta_phy","eta_ep","rho_phy","rho_ep")) 
write.csv(data.frame(ai_post), file="ai_noIE_post.csv")
...
write.csv(data.frame(vi_prec), file="vi_noIE_prec.csv")
vi_post <- extract.samples(vi,pars=c("cutpoints","bVI","bPD","bDC","bAL","bIC","eta_phy","eta_ep","rho_phy","rho_ep")) 
write.csv(data.frame(vi_post), file="vi_noIE_post.csv")
...
write.csv(data.frame(vn_prec), file="vn_noIE_prec.csv")
vn_post <- extract.samples(vn,pars=c("cutpoints","bVN","bVI","phy","ep","eta_phy","eta_ep","rho_phy","rho_ep")) 
write.csv(data.frame(vn_post), file="vn_noIE_post.csv")
